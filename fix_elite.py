print("Final tuning: stronger draw + convergence for elite...")
...
old_block = '''    # Dynamic blend based on rank gap AND team tier
...
if old_block in code:
    ...
    print("  - both_top: rank <= 25 -> <= 30")
    print("  - Ranking weight for top: 50% -> 55%")
    print("  - Form regression for top: 45% -> 50%")
    print("  - Convergence range: < 40 -> < 50")
    print("  - Convergence strength top: 35% -> 40%")
    print("  - Draw target: 1.10 -> 1.15")
    print("  - Draw pull top: 15% -> 20%")
    print("  - Draw range: < 30 -> < 35")
else:
